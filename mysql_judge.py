...
def get_expected_output(object_name):
    ...
    try:
        ...
        redis_client.set(object_name, data_from_storage)
...
def compare_output(user_output: str, expected_output_file_path: str) -> str:
    ...
    try:
        ...
        expected_output = get_expected_output(object_name=expected_output_file_path)
...
def judge_one_testcase(issue: dict, data: dict, testcase_index: int) -> None:
    try:
        ...
        if need_compare_result:
            ...
            compare_status = compare_output(execution_result['user_output'], testcase['output_file_path'])
            raise JudgerException(
